...
- [x] **Zawrzeć Kartę Powierzenia Danych w EmailLabs** (Konto → RODO → „+") — zawarta 11.09.2026. Pozostaje pobrać PDF i zarchiwizować. Polityka prywatności ujawnia Vercom S.A. publicznie jako podmiot przetwarzający od wersji 1.4.
