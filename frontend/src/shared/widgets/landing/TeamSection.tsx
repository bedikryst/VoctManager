...
export default function TeamSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative bg-[#fdfbf7] text-stone-900 h-auto py-12 md:py-0 md:h-[150vh] selection:bg-brand selection:text-white"
    >
      <div className="relative md:sticky md:top-0 md:h-screen w-full flex flex-col justify-center overflow-hidden">
        ...
        <div
          className="absolute inset-0 max-w-7xl mx-auto px-6 md:px-0 w-full hidden md:block z-0 pointer-events-none"
          aria-hidden="true"
        >
          <div className="absolute top-[13.2%] left-[70.75%] w-[2px] h-[15%] bg-stone-200/30">
            <motion.div
              style={{ scaleY: topVerticalProgress }}
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-0 relative z-20 w-full">
          <div className="flex flex-col md:flex-row relative items-center">
            ...
            <div
              ref={textBlockRef}
              className="md:w-5/12 relative md:pr-16 lg:pr-20 z-10 w-full mb-20 md:mb-0"
            >
              <motion.div
                style={{
                  opacity: textOpacity,
              ...
              >
                ...
                <div className="flex flex-col w-max mb-12">
                  <ElegantHeading
                    text="Wspólnota"
                    className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-medium tracking-tight leading-[0.95] inline-block"
                  />
                  <ElegantHeading
                    text="Artystyczna"
                    className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-medium tracking-tight leading-[0.95] inline-block"
                ...
                <p
                  className="text-xl md:text-2xl text-stone-800 leading-snug mb-8 italic border-l-2 border-brand/30 pl-6"
                  style={{ fontFamily: "'Cormorant', serif" }}
                >
                  "VoctEnsemble to nie tylko głosy – to żywy organizm, którego
                  tożsamość opiera się na jedności artystycznej i ludzkiej
                  harmonii."
                </p>
                <p className="text-sm text-stone-500 font-light leading-relaxed pl-6">
                  Pod kierownictwem Florent’a de Bazelaire wnosimy na polską
                  scenę muzyczną nową jakość estetyczną i duchową. Naszą misją
                  jest zgłębianie człowieczeństwa za pomocą muzyki sakralnej.
                </p>
              </motion.div>
            </div>
                ...
                <div className="relative w-full max-w-sm aspect-[3/4] mx-auto z-20">
                  ...
                  <div className="absolute -inset-4 md:-inset-6 z-30 pointer-events-none hidden md:block">
                    <motion.div
                      ...
                      className="absolute top-0 left-0 right-0 h-px bg-brand/40 origin-center"
                    />
                    <motion.div
                      style={{ scaleX: frameProgress }}
                      className="absolute bottom-0 left-0 right-0 h-px bg-brand/40 origin-center"
                    />
                    <motion.div
                      style={{ scaleY: frameProgress }}
                      className="absolute top-0 bottom-0 left-0 w-px bg-brand/40 origin-center"
                    />
                    <motion.div
                      style={{ scaleY: frameProgress }}
                      className="absolute top-0 bottom-0 right-0 w-px bg-brand/40 origin-center"
                    />
                  </div>
                  ...
                  <div className="absolute inset-0 overflow-hidden bg-stone-200 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.3)]">
                    ...
                    <div className="absolute bottom-6 left-6 right-6 flex flex-col items-start text-left text-white pointer-events-none transform transition-transform duration-1000 group-hover:-translate-y-2">
                      <p className="text-[9px] uppercase tracking-[0.3em] font-bold text-white/60 mb-2">
                        Dyrygent & Założyciel
                      </p>
                      <h4
