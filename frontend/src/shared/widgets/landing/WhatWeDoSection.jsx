...
export default function WhatWeDoSection() {
  ...
  const branch2Progress = useTransform(
    scrollYProgress,
    [0.3815, 0.415],
    [0, 1],
  );
  ...
  const renderHoverText = (text, image) => (
    <span
      className="text-brand font-medium md:cursor-none relative inline-block group pointer-events-none md:pointer-events-auto"
      onMouseEnter={() => {
    ...
    >
      {text}
      <span className="absolute bottom-0 left-0 w-full h-px bg-brand scale-x-0 md:group-hover:scale-x-100 origin-left transition-transform duration-300" />
    </span>
  );
  ...
  return (
    <section
      ref={sectionRef}
      className="relative bg-[#fdfbf7] text-stone-900 -mb-15 selection:bg-brand selection:text-white overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-0 relative z-10">
        ...
        <div className="absolute top-[1%] md:top-[5%] left-0 md:left-[41.666667%] w-[50.5%] md:w-[8.5%] h-[2px] bg-stone-200/50">
          <motion.div
            ...
            className="w-full h-full bg-brand origin-right opacity-50"
          />
        </div>
        ...
        <div className="absolute -top-[2%] md:top-0 left-[50%] w-[2px] h-[3%] md:h-[5%] bg-stone-200/50">
          <motion.div
            ...
            className="w-full h-full bg-brand origin-top opacity-50"
          />
          {/* <div className="absolute top-0 -left-30 w-35 h-20 md:h-48 bg-gradient-to-b from-[#fdfbf7] to-transparent z-10" />*/}
        </div>

        <div
          className="absolute top-[5%] bottom-0 left-[41.666667%] w-[2px] bg-stone-200/50 hidden md:block z-0"
          aria-hidden="true"
        >
          <motion.div
            style={{ scaleY: lineProgress2 }}
            className="w-full h-full bg-brand origin-top opacity-50"
          />
        </div>
        ...
        <div
          ref={block1Ref}
          className="flex flex-col md:flex-row min-h-[50vh] mt-15 md:mt-0 mb-8 md:mb-0 relative pb-8 md:pb-0"
        >
          <div className="md:w-5/12 relative md:pr-12 lg:pr-8">
            <div className="md:sticky md:top-48 z-10 w-full pt-20 md:pt-0">
              <div
                className="hidden md:flex absolute top-6 md:-right-12 lg:-right-8 w-[12vw] lg:w-[15vw] h-px items-center justify-start z-0"
                aria-hidden="true"
              >
                <motion.div
                  style={{ scaleX: branch1Progress }}
                  className="w-full h-full bg-brand/70 origin-right"
                />
                <motion.div
                  style={{ opacity: dot1Opacity }}
                  className="absolute left-0 w-2 h-2 rounded-full bg-brand shadow-[0_0_12px_rgba(0,35,149,0.5)]"
                />
              </div>
              ...
              >
                <p className="text-brand text-[9px] font-bold uppercase tracking-[0.2em] md:tracking-[0.3em] mb-4">
                  I. Działalność
                </p>
          ...
          >
            <p
              className="text-2xl md:text-4xl text-stone-800 leading-snug mb-8"
              style={{ fontFamily: "'Cormorant', serif" }}
            >
              Przywracamy tradycję dawnych{" "}
              <span className="text-brand italic">Concerts Spirituels</span>.
              Tworzymy pomost między historyczną świadomością a potrzebami
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-6 sm:gap-12">
              <Link
                to="/kontakt"
                className="group flex items-center gap-4 text-[10px] md:text-xs uppercase tracking-[0.2em] font-medium text-brand md:text-stone-500 md:hover:text-brand transition-colors"
              >
                <span className="relative overflow-hidden pb-1">
                  Zabookuj koncert
                  <span className="hidden md:block absolute bottom-0 left-0 w-full h-px bg-brand md:bg-stone-300 origin-left scale-x-100 transition-transform duration-500 md:group-hover:scale-x-0" />
                  <span className="hidden md:block absolute bottom-0 left-0 w-full h-px bg-brand origin-right scale-x-0 transition-transform duration-500 md:group-hover:scale-x-100" />
                </span>
                <span className="w-8 h-px bg-brand md:bg-stone-300 md:group-hover:bg-brand md:group-hover:w-16 transition-all duration-500" />
              </Link>
              <Link
                to="/projekty"
                className="group flex items-center gap-4 text-[10px] md:text-xs uppercase tracking-[0.2em] font-medium text-brand md:text-stone-500 md:hover:text-brand transition-colors"
              >
                ...
                <span className="relative overflow-hidden pb-1">
                  Zobacz projekty
                  <span className="hidden md:block absolute bottom-0 right-0 w-full h-px bg-brand md:bg-stone-300 origin-right scale-x-100 transition-transform duration-500 md:group-hover:scale-x-0" />
                  <span className="hidden md:block absolute bottom-0 right-0 w-full h-px bg-brand origin-left scale-x-0 transition-transform duration-500 md:group-hover:scale-x-100" />
                </span>
              </Link>
            </div>
          </motion.div>
        ...
        <div
          ref={block2Ref}
          className="flex flex-col md:flex-row min-h-[50vh] mb-8 md:mb-0 relative pb-8 md:pb-0"
        >
          <div className="md:w-5/12 relative md:pr-12 lg:pr-8">
            <div className="md:sticky md:top-48 z-10 w-full pt-8 md:pt-0">
              ...
              <motion.div
                ...
                className="md:pl-[4vw] lg:pl-[1vw] xl:pl-0 md:pt-14 relative z-10 text-left"
              >
                <p className="text-brand text-[10px] font-bold uppercase tracking-[0.2em] md:tracking-[0.3em] mb-4">
                ...
                <div className="flex flex-col w-max">
                  ...
                  <div>
                    <span
                      className="italic text-5xl md:text-6xl lg:text-8xl font-medium tracking-tight leading-[0.95] pr-3"
                      style={{ fontFamily: "'Cormorant', serif" }}
                    >
                      &
                    </span>
          ...
          >
            <p
              className="text-2xl md:text-4xl text-stone-800 leading-snug mb-12 pr-6 md:pr-0"
              style={{ fontFamily: "'Cormorant', serif" }}
            >
              Nasze koncerty to nowoczesne misteria. Aby dźwięk mógł w pełni
              rezonować z przestrzenią, zapraszamy do współpracy
              profesjonalistów sztuki.
            </p>
            <div
              className="w-full relative cursor-none"
              onMouseEnter={enterDrag}
              onMouseLeave={leaveDrag}
            >
              <div
                ref={sliderRef}
                className="overflow-hidden pb-4 md:pb-8 pr-6 md:pr-0"
              >
                <motion.div
                  drag="x"
                  dragConstraints={{ right: 0, left: -sliderWidth }}
                  style={{ x }}
                  className="flex gap-4 md:gap-8 force-no-cursor w-max touch-pan-y"
                >
              ...
              <div className="md:hidden mt-2 h-[2px] w-full pr-6 bg-brand/10 rounded-full overflow-hidden">
                <motion.div
              ...
              <div className="mt-8 pr-6 md:pr-0 flex justify-end">
                <Link
                  to="/"
                  className="group flex items-center gap-4 text-[10px] md:text-xs uppercase tracking-[0.2em] font-medium text-stone-500 hover:text-brand transition-colors"
                  onMouseEnter={leaveDrag}
                  onMouseLeave={enterDrag}
                >
                  <span className="relative overflow-hidden pb-1">
                    Więcej o synergii
                    <span className="absolute bottom-0 left-0 w-full h-px bg-stone-300 origin-left scale-x-100 transition-transform duration-500 group-hover:scale-x-0" />
                    <span className="absolute bottom-0 left-0 w-full h-px bg-brand origin-right scale-x-0 transition-transform duration-500 group-hover:scale-x-100" />
                  </span>
                  <span className="w-8 h-px bg-stone-300 group-hover:bg-brand group-hover:w-16 transition-all duration-500" />
                </Link>
              </div>
            </div>
          </motion.div>
        ...
        >
          ...
          >
            <div className="relative pl-8 md:pl-0 py-4">
              <div
                className="absolute left-0 top-[10px] bottom-[6px] w-px bg-brand origin-top md:hidden"
                aria-hidden="true"
              />

              <p
                className="text-2xl md:text-4xl text-stone-800 mb-6 leading-snug"
                style={{ fontFamily: "'Cormorant', serif" }}
              >
                Wzbogaciliśmy liturgię podczas obchodów 28. Dnia Judaizmu w
                Kościele katolickim pod przewodnictwem bp Roberta Chrząszcza.
              </p>
              <p className="text-stone-500 font-light text-base max-w-lg leading-relaxed">
                Dopełnieniem tego wydarzenia był nasz występ w krakowskiej{" "}
                {renderHoverText("Synagodze Tempel", "/miejsce_tempel.webp")} w
                ramach wspomnienia o Błogosławionej Pamięci Tadeuszu
                Jakubowiczu.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 pb-10 md:pb-0">
              <div>
                <h4 className="text-brand font-bold mb-4 uppercase text-[10px] tracking-[0.2em]">
                  Stolica Apostolska
                </h4>
                <p className="text-stone-600 text-sm font-light leading-relaxed">
                  W najbliższym czasie uświetnimy liturgię w{" "}
                  {renderHoverText(
                    "Sanktuarium św. Andrzeja Boboli",
                    "/miejsce_sanktuarium.webp",
                  )}{" "}
                  w obecności o. Generała jezuitów, o. Artura Sosy-Abascala SJ.
                </p>
              </div>
              <div>
                <h4 className="text-brand font-bold mb-4 uppercase text-[10px] tracking-[0.2em]">
                ...
                <p className="text-stone-600 text-sm font-light leading-relaxed">
                  Mieliśmy zaszczyt oprawiać liturgie ślubne w tak
                  monumentalnych przestrzeniach jak{" "}
                  {renderHoverText(
                    "Kolegiata św. Anny",
                    "/miejsce_kolegiata.webp",
                  )}{" "}
                  w Krakowie czy historyczne{" "}
                  {renderHoverText(
