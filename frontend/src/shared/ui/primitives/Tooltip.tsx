          ...
          <TooltipPrimitive.Portal forceMount key="tooltip-portal">
            ...
            >
              <motion.div
                ...
                className="relative px-3 pb-1 rounded-chip border border-ethereal-gold/50 bg-ethereal-parchment/90 backdrop-blur-xl shadow-(--shadow-ethereal-soft) will-change-transform"
              >
                <Label
                  size="sm"
                  color="graphite"
