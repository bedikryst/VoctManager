...
export const InlineEditable = ({
  ...
  // The surface comes from the shell like every other field in the product (D4)
  // — this was the last hand-rolled copy of the gold hairline and the focus
  // ring, and it had drifted to a 1px ring on a chip radius. Only layout and
