...
export const Input = React.forwardRef<HTMLInputElement, InputProps>(
    ({ leftIcon, rightElement, hasError = false, isDark = false, className = '', ...props }, ref) => {
        
        const baseStyles = "w-full text-sm rounded-xl focus:outline-none focus:ring-2 transition-all shadow-[inset_0_1px_2px_rgba(0,0,0,0.02)]";
        ...
        const errorStyles = hasError ? "border-red-400 focus:ring-red-500/20 text-red-900 bg-red-50" : "";
