...
export default function RehearsalsWidget({ project, onEdit }: RehearsalsWidgetProps): React.JSX.Element {
    const { rehearsals: projectRehearsals, participations: projectParticipations } = useProjectData(String(project.id));
                                            ...
                                            <div className="flex flex-col">
                                                ...
                                                {absences > 0 && (
                                                    <span className="flex items-center gap-1 text-[9px] font-bold antialiased uppercase tracking-widest text-red-500 mt-1">
                                                        <UserMinus size={10} aria-hidden="true" /> Zgłoszono braki: {absences}
                                                    </span>
                                                )}
                                            </div>
                                        </div>
