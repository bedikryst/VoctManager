...
const DashboardSection = ({
  ...
  <div className={className}>
    <div className="mb-6 flex items-center gap-3">
      <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-ethereal-gold/10 text-ethereal-gold ring-1 ring-ethereal-gold/15">
        {icon}
      </div>
      <Heading as="h3" size="lg" weight="medium" className="tracking-tight">
        {title}
      </Heading>
      <div
        className="h-px flex-1 bg-gradient-to-r from-ethereal-incense/20 to-transparent"
        aria-hidden="true"
      />
    </div>
    {children}
