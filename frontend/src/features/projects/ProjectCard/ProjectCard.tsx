...
const STYLE_DISABLED = "bg-stone-50/50 border-stone-200/60 rounded-2xl opacity-75 grayscale hover:grayscale-0 transition-all duration-300";
...
export default function ProjectCard({ project, index, onEdit, onDelete }: ProjectCardProps): React.JSX.Element {
                            ...
                            <div className="p-5 md:p-8 space-y-10">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                        <div className="lg:col-span-2">
                                            <RehearsalsWidget project={project} onEdit={() => onEdit('REHEARSALS')} />
                                        </div>
                                        <div className="lg:col-span-1">
                                            <ProgramWidget project={project} onEdit={() => onEdit('PROGRAM')} onOpenMicroCast={() => onEdit('MICRO_CAST')} />
                                        </div>
                                        <div className="lg:col-span-2">
                                            <CastWidget project={project} onEdit={() => onEdit('CAST')} />
                                        </div>
                                        <div className="lg:col-span-1">
                                ...
                                <div className="space-y-4 pt-6 border-t border-stone-200/50">
                                    <h4 className="flex items-center gap-2 text-[10px] font-bold antialiased uppercase tracking-widest text-stone-500">
                                        <Wrench size={14} aria-hidden="true" /> Logistyka i Produkcja
                                    </h4>
                                    
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                        <div className="flex flex-col h-full">
                                            <RunSheetWidget project={project} onEdit={() => onEdit('DETAILS')} />
                                        </div>
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 pt-4">
                                        <div className="lg:col-span-2">
                                            <BudgetWidget project={project} onEdit={() => onEdit('BUDGET')} />
                                        </div>
                                        <div className="lg:col-span-1">
                                            <CrewWidget project={project} onEdit={() => onEdit('CREW')} />
                                        </div>
                                    </div>
                                </div>
