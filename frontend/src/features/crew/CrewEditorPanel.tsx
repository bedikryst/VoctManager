 ...
 * Implements dirty-state tracking to prevent data loss. Uses React Portal.
                                ...
                                <div className="flex-1 space-y-5">
                                    ...
                                    <div className="grid grid-cols-2 gap-5">
                                        <div>
                                            ...
                                            <Input type="email" value={formData.email} onChange={e => setFormData({...formData, email: e.target.value})} disabled={isSubmitting} />
                                        </div>
                                        <div>
                                    ...
                                    <div className="space-y-5 pt-4 border-t border-stone-200/60">
                                        ...
                                        <div>
                                            ...
                                            <select value={formData.specialty} onChange={e => setFormData({...formData, specialty: e.target.value})} className={`${STYLE_SELECT} font-bold text-stone-700 appearance-none`} disabled={isSubmitting}>
                                        ...
                                        <div>
                                            ...
                                            <Input type="text" placeholder="np. SoundTech Pro Sp. z o.o." value={formData.company_name} onChange={e => setFormData({...formData, company_name: e.target.value})} disabled={isSubmitting} className="font-bold" />
                                        </div>
                                    </div>
                                </div>
