 ...
 * @description Compact radial progress dial for roll-call completion. Pure SVG,
 * no motion infrastructure — cheap enough to render once per rehearsal row.
 * @architecture Enterprise SaaS 2026
 * @module features/rehearsals/components/CompletionRing
 */
