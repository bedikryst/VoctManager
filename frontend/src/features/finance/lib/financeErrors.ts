...
const FINANCE_ERROR_COPY: Record<string, string> = {
  ...
  plan_empty: "Kosztorys jest pusty, więc nie ma czego zatwierdzać. Budżet bez kosztorysu zarząd po prostu zamyka.",
  plan_not_approved: "Budżet ma kosztorys, którego zarząd jeszcze nie zatwierdził. Zatwierdź go przed zamknięciem budżetu.",
  grant_needs_plan: "Projekt ma przyznany grant, a grant rozlicza się według zatwierdzonego kosztorysu. Dodaj kosztorys i zatwierdź go przed zamknięciem budżetu.",
