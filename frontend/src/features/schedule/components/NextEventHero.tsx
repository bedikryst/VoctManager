  ...
  return (
    <GlassCard variant="dark" glow withNoise isHoverable={false} padding="none">
      <div className="p-5 sm:p-6">
        ...
        <Heading as="h2" size="3xl" weight="bold" color="white" className="mt-3 leading-tight">
          {event.title}
        </Heading>
        ...
        <div className="mt-4 flex flex-wrap items-center gap-2">
          ...
          {proj.call_time && (
            <DualTimeDisplay
              ...
              primaryTimeClassName="flex items-center gap-1.5 font-medium"
              localTimeClassName="text-[9px] text-ethereal-parchment/70 border-l border-ethereal-gold/40 pl-1.5"
            />
          )}
          <LocationPreview
          ...
          {combinedDressCode && (
            <Eyebrow
              as="span"
              color="parchment"
              className="flex max-w-56 items-center gap-1.5 truncate rounded-lg border border-ethereal-incense/40 bg-ethereal-incense/15 px-2.5 py-1"
      ...
      <div className="flex items-center justify-between gap-3 border-t border-ethereal-incense/15 bg-ethereal-ink/30 px-5 py-3 sm:px-6">
        <Text size="xs" color="parchment-muted" className="text-ethereal-parchment/70">
          {t(
...
const RehearsalHero = ({
  ...
  const countdown = useCountdownLabel(event.date_time);
  const isLive = isRehearsalLive(event, new Date());
      ...
      <div className="p-5 sm:p-6">
        ...
        {event.focus && (
          <div className="mt-4 rounded-2xl border border-ethereal-incense/15 bg-ethereal-alabaster/60 p-3.5">
            ...
            <Text size="sm" className="whitespace-pre-wrap font-serif italic leading-relaxed">
              {event.focus}
            </Text>
          </div>
        )}
          ...
          <div className="mt-4 flex gap-2">
            {currentMaskedStatus !== "PRESENT" && (
              <Button
                ...
                className="flex-1 bg-ethereal-sage border-ethereal-sage hover:bg-ethereal-sage/80 sm:flex-none"
              >
      ...
      {isLive && (
        <div className="border-t border-ethereal-incense/15 bg-ethereal-parchment/30 p-5 sm:p-6">
          ...
          {isProgramLoading ? (
            ...
            <div className="flex max-h-[42dvh] flex-col gap-1.5 overflow-y-auto no-scrollbar">
              {[...programItems]
