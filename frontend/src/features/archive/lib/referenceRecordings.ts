...
export const getReferenceRecordingLinks = (
  piece: Pick<Piece, 'reference_recording' | 'reference_recording_youtube' | 'reference_recording_spotify'>
...
export const getPrimaryReferenceRecording = (
  piece: Pick<Piece, 'reference_recording' | 'reference_recording_youtube' | 'reference_recording_spotify'>
): ReferenceRecordingLink | null => getReferenceRecordingLinks(piece)[0] ?? null;
