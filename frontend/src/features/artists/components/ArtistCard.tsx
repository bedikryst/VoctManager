...
export const ArtistCard = React.memo(({ 
    ...
    return (
        ...
        >
            <GlassCard className={`flex flex-col justify-between h-full ${!artist.is_active ? 'bg-stone-50/30' : ''}`}>
                ...
                <div className="flex gap-3 border-t border-stone-100/50 pt-5 relative z-10">
                    ...
                    <Button 
                        ...
                        leftIcon={artist.is_active ? <Trash2 size={14} aria-hidden="true" /> : <CheckCircle2 size={14} aria-hidden="true" />}
