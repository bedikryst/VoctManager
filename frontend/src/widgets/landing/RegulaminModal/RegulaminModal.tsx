 ...
 * @description Donation terms-of-use overlay, layered above the vault sheet. The
 * "Akceptuję regulamin" button flips the give-form consent checkbox via the shared
 * VaultContext acceptor. Scroll-end detection fades the bottom veil once the donor
 * has read to the end.
 * @architecture Enterprise SaaS 2026
 * @module widgets/landing/RegulaminModal
 */
