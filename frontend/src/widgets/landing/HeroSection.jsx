...
export default function HeroSection() {
  ...
  const silenceSpacing = useTransform(
    scrollYProgress,
    [0.2, 0.35],
    ["0.5em", "0.1em"],
  );
  ...
  return (
    ...
    >
      ...
      <button
        ...
        aria-label={
          isSoundOn ? "Disable ambient sound" : "Enable ambient sound"
        }
      >
      ...
      <div className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute top-0 bottom-0 left-1/2 -translate-x-1/2 w-px bg-stone-200/50 z-0 pointer-events-none">
          <motion.div
            ...
            className="w-full h-full bg-brand origin-top opacity-100"
          />
        </div>
        ...
        >
          <p
            className="font-medium text-stone-500 text-xl md:text-3xl italic tracking-wide"
            style={{ fontFamily: "'Cormorant', serif" }}
          >
            z tęsknoty, natchnienia i marzenia.
          </p>
          <p
            className="mt-6 md:mt-8 px-4 text-sm md:text-base text-stone-400 leading-relaxed font-light"
            style={{ fontFamily: "'Poppins', sans-serif" }}
          >
            Jak anachoreci, w odosobnieniu, z daleka od zgiełku
            <br className="hidden md:block" />i muzyki, zatęskniono za muzyką.
          </p>
        </motion.div>
        ...
        <motion.div
          style={{
            ...
            willChange: "transform, opacity, filter",
            background:
              "linear-gradient(to bottom, rgba(253,251,247,0) 0%, rgba(253,251,247,1) 25%, rgba(253,251,247,1) 75%, rgba(253,251,247,0) 100%)",
          }}
        ...
        >
          <h2
            className="flex flex-col items-center gap-4 md:gap-6 text-3xl md:text-6xl lg:text-8xl font-medium uppercase text-stone-900"
            style={{ fontFamily: "'Cormorant', serif" }}
          >
            <span className="opacity-60 inline-block tracking-[0.2em]">
              Music
            </span>
            <motion.span
              style={{ letterSpacing: silenceSpacing }}
              className="text-brand italic lowercase text-3xl md:text-5xl lg:text-7xl flex items-center gap-4"
            >
              <span className="opacity-40 font-light">—</span>silence
        ...
        <motion.div
          style={{
            ...
            willChange: "transform, opacity, filter",
            background:
              "linear-gradient(to bottom, rgba(253,251,247,0) 0%, rgba(253,251,247,1) 20%, rgba(253,251,247,1) 80%, rgba(253,251,247,0) 100%)",
          }}
        ...
        >
          <div
            className="space-y-4 md:space-y-6 font-medium text-lg md:text-3xl leading-relaxed flex flex-col items-center text-stone-600 max-w-3xl w-full"
            style={{ fontFamily: "'Cormorant', serif" }}
          >
            ...
            <div className="pt-6 mt-6 md:pt-8 md:mt-8 flex flex-col items-center relative w-full">
              <div
                className="absolute top-0 md:-top-3 w-24 md:w-32 h-[1px] bg-gradient-to-r from-transparent via-brand/30 to-transparent"
                aria-hidden="true"
              />
              <p className="text-stone-500 text-[15px] md:text-2xl italic tracking-wide leading-snug">
        ...
        <motion.div
          ...
          className="absolute bottom-8 text-[9px] uppercase tracking-[0.4em] font-medium text-stone-400 flex flex-col items-center gap-4 z-40 pointer-events-none"
        >
