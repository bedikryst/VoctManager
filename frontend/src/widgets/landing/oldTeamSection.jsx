...
const board = [
  {
    ...
    description:
      "Inicjator i dyrektor artystyczny. Odpowiada za jedność brzmienia i duchowy wymiar repertuaru.",
    img: "/flordraw.jpeg",
    video: "/florvideo.mp4",
  },
  {
    ...
    description:
      "Architektka relacji i wizerunku. Dba o to, by wizja artystyczna spotkała się z perfekcyjną realizacją.",
    img: "/aniadraw.jpeg",
    video: "/ania2.mp4",
  },
  {
    ...
    description:
      "Twórca ekosystemu VoctManager. Odpowiada za innowacje cyfrowe i technologiczną niezależność zespołu.",
    img: "/krystdraw.jpeg",
...
const TeamMemberCard = ({ member, scrollTransform, gyroX, gyroY }) => {
  return (
    <motion.div
      ...
      className="flex flex-col group relative z-10"
    >
      <div
        className="relative aspect-[3/4] overflow-hidden bg-white mb-8 border border-stone-200"
      ...
      {/* Typography & Copy */}
      <h3
        className="text-3xl md:text-4xl mb-2 tracking-tighter text-stone-900"
        style={{ fontFamily: "'Cormorant', serif" }}
      >
        {member.name}
      </h3>
      <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-amber-700 mb-6">
        {member.role}
      </p>
...
export default function TeamSection() {
  ...
  return (
    <section
      id="zespol"
      ref={containerRef}
      className="bg-stone-50 pt-40 md:pt-64 z-20 relative overflow-hidden pb-16 md:pb-24"
    >
      <div className="max-w-screen-2xl mx-auto px-6 md:px-12 relative">
        {/* Section Header with Typographic Mask */}
        <div className="mb-24 md:mb-40">
          <p className="mb-6 text-[10px] font-bold uppercase tracking-[0.4em] text-amber-700">
            Struktura
          </p>
