 ...
 * @description Companion payment method in the vault: opens the foundation's Zrzutka.pl
 * page in a new tab. Supports BLIK, card, Apple Pay, Google Pay and recurring contributions.
 * @architecture Enterprise SaaS 2026
 * @module widgets/landing/VaultModal/ZrzutkaPanel
 */
