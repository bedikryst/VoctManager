...
const composers = [
  {
    ...
    audioSrc: "/samples/Gregorio_Allegri_Miserere.mp3",
  },
  {
    name: "Johann Sebastian Bach",
    piece: "Singet dem Herrn ein neues Lied, BWV 225",
    audioSrc: "/samples/Bach_Singet.mp3",
  },
  ...
  { name: "Marco Frisina", piece: "Anima Christi" },
  {
    ...
    piece: "Drop, drop, slow tears • O clap your hands",
  },
  ...
  { name: "David MacIntyre", piece: "Ave Maria" },
  {
    ...
    piece: "Cantate Domino • Quel augellin che canta",
  },
  { name: "Wolfgang Amadeus Mozart", piece: "Ave verum corpus" },
  {
    name: "Giovanni Pierluigi da Palestrina",
    piece: "Super flumina Babylonis",
  },
  {
    name: "Arvo Pärt",
    piece: "Da Pacem Domine • Nunc dimittis • The Deer's Cry",
  },
  ...
  {
    name: "John Tavener",
    piece: "A Hymn to the Mother of God • Song for Athene",
  },
  { name: "Ralph Vaughan Williams", piece: "The Lark Ascending" },
  { name: "Tomás Luis de Victoria", piece: "Alma Redemptoris Mater" },
  {
    name: "Bernat Vivancos",
    piece: "A Child is born • Aeternam • Le cri des bergers",
  },
...
const traditional = [
  ...
  {
    name: "Salve Regina",
    piece: "Tradycyjna melodia z Oksytanii",
    audioSrc: "/samples/salve-regina.mp3",
  },
  ...
  return (
    <motion.div
      ...
      className={`group flex flex-col md:flex-row md:items-baseline justify-between py-5 md:py-6 border-b border-stone-800/10 transition-all duration-500 
        ...
        ${isPlaying ? "opacity-100 border-brand" : "md:hover:!opacity-100 md:hover:border-stone-800/40 md:opacity-100"}
      `}
    >
      <div className="flex items-baseline gap-4 md:gap-6">
        <span
          className={`text-[9px] font-bold tracking-[0.2em] transition-colors duration-500 ${isPlaying ? "text-brand" : "text-stone-400 group-hover:text-brand"}`}
        >
          {String(index).padStart(2, "0")}
        </span>
        <h4
          className={`text-xl md:text-3xl lg:text-4xl transition-colors duration-500 ${isPlaying ? "text-brand" : "text-stone-800 group-hover:text-brand"}`}
      ...
      <div className="flex flex-col md:items-end mt-2 md:mt-0">
        <p
          className={`text-xs md:text-sm font-light tracking-wide text-left md:text-right transition-colors duration-500 md:max-w-[80%] ${isPlaying ? "text-stone-900" : "text-stone-400 group-hover:text-stone-600"}`}
        >
          {piece}
        </p>
        ...
        {hasAudio && (
          <div className="mt-2 md:mt-3 flex items-center gap-2 overflow-hidden h-4">
            ...
            >
              ...
              <span className="text-[8px] uppercase tracking-[0.2em] font-bold text-brand">
                Odtwarzanie
              </span>
            </motion.div>
            ...
            {!isPlaying && (
              <motion.span
                ...
                className="text-[8px] uppercase tracking-[0.2em] font-bold text-stone-300 group-hover:text-brand transition-colors duration-500"
              >
                [ Odsłuchaj ]
              </motion.span>
            )}
...
export default function WhatWeSingSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative bg-[#fdfbf7] text-stone-900 selection:bg-brand selection:text-white overflow-hidden"
    >
      <motion.div
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-0 relative z-10">
        {/* Grid Lines */}
        <div
          className="hidden md:block absolute -top-9 left-[41.666667%] w-[16.666667%] h-[2px] bg-stone-200/50 z-0"
          aria-hidden="true"
        >
          <motion.div
            style={{ scaleX: horizontalProgress }}
            className="w-full h-full bg-brand origin-left opacity-50"
          />
        </div>
        <div
          className="absolute -top-9 bottom-0 left-[58.333333%] w-[2px] bg-stone-200/50 hidden md:block z-0"
          aria-hidden="true"
        >
          <motion.div
        ...
        <div
          ref={block1Ref}
          className="flex flex-col md:flex-row-reverse min-h-[60vh] mb-24 md:mb-40 relative mt-16 md:mt-24"
        >
          <div className="md:w-5/12 relative md:pl-12 lg:pl-16 mb-12 md:mb-0">
            <div className="md:sticky md:top-48 z-10 w-full text-left">
              <div
                className="hidden md:flex absolute top-6 md:-left-12 lg:-left-16 w-[12vw] lg:w-[15vw] h-px items-center justify-start z-0"
                aria-hidden="true"
              >
                <motion.div
                  style={{ scaleX: branch1Progress }}
                  className="w-full h-full bg-brand/70 origin-left"
                />
                <motion.div
                  style={{ opacity: dot1Opacity }}
                  className="absolute right-0 w-2 h-2 rounded-full bg-brand shadow-[0_0_12px_rgba(0,35,149,0.5)]"
                />
              </div>
              ...
              >
                <p className="text-brand text-[9px] md:text-[10px] font-bold uppercase tracking-[0.2em] md:tracking-[0.3em] mb-4">
                  IV. Filozofia
                </p>
                <div className="flex flex-col w-max">
                  <ElegantHeading
                    text="Manifest"
                    className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-medium tracking-tight leading-[0.95] inline-block"
                  />
                  <ElegantHeading
                    text="Brzmienia"
                    className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-medium tracking-tight leading-[0.95] inline-block"
          ...
          <motion.div
            style={{
              y: isMobile ? yParallaxSlow : yParallaxFast,
              willChange: "transform",
            }}
            className="md:w-7/12 flex flex-col justify-center relative z-0 md:pr-16 lg:pr-24 md:pt-12"
          >
            <motion.div
              style={{
                opacity: block1Opacity,
            ...
            >
              <p
                className="text-xl md:text-2xl text-stone-600 leading-relaxed max-w-lg mb-12 italic"
                style={{ fontFamily: "'Cormorant', serif" }}
              >
                Nade wszystko, dzielimy się. Utkaliśmy przemyślaną narrację, w
                której muzyka i słowo są lustrzanym odbiciem samych siebie.
              </p>

              <h3
                className="text-3xl sm:text-4xl md:text-6xl lg:text-[5rem] leading-[1.1] font-medium text-stone-800 mb-16"
                style={{ fontFamily: "'Cormorant', serif" }}
              >
                Ubóstwiamy
                <br />
                <span className="italic text-brand">heterofonię</span>,
                <br />
                politonalność
                <br />
                <span className="text-stone-400">&</span>{" "}
                <span className="italic text-brand">polifonię.</span>
              </h3>

              <div className="relative pl-6 md:pl-8 border-l border-brand/30">
                <p className="text-sm text-stone-500 font-light leading-relaxed max-w-md mb-6">
                  Nie czulibyśmy się sobą, śpiewając muzykę, która nie dotyka
                  głębi człowieka i nie próbuje urzec go pięknem mimo jego
                  kruchości.
                </p>
                <p className="text-sm text-stone-500 font-light leading-relaxed max-w-md font-medium">
                  Interesuje nas świat widzialny i niematerialny. Muzyka
                  sakralna czerpie z mądrości przodków — i to do tej przestrzeni
        ...
        <div
          ref={block2Ref}
          className="flex flex-col md:flex-row-reverse relative"
        >
          <div className="md:w-5/12 relative md:pl-12 lg:pl-16 mb-12 md:mb-0">
            <div className="md:sticky md:top-48 z-10 w-full text-left">
              <div
                  ...
                  <div className="md:hidden flex justify-center mt-12 mb-8">
                    <button
                      onClick={() => {
                        setIsExpanded(false);
                        document
                          .getElementById("repertoire-container")
                          ?.scrollIntoView({
                            behavior: "smooth",
                            block: "start",
                          });
                      }}
                      className="group flex items-center justify-center gap-3 px-6 py-3 border border-stone-300 rounded-full text-[9px] uppercase tracking-[0.2em] font-bold text-stone-500 hover:border-brand hover:text-brand transition-all duration-500 active:scale-95"
                    >
                      Zwiń archiwum
                    </button>
                  </div>
              ...
              {!isExpanded && (
                <div className="md:hidden absolute bottom-0 left-0 right-0 h-48 bg-gradient-to-t from-[#fdfbf7] via-[#fdfbf7]/90 to-transparent z-30 flex items-end justify-center pb-2">
                  <button
                    ...
                    className="group flex items-center justify-center gap-3 px-6 py-3 border border-brand rounded-full text-[9px] uppercase tracking-[0.2em] font-bold text-brand hover:bg-brand hover:text-white transition-all duration-500 active:scale-95"
                  >
                    Eksploruj archiwum
                  </button>
                </div>
