 ...
 * The `getSpotifyEmbedUrl` specifically implements a deterministic URL parser that 
 * intercepts standard Spotify share links and upgrades them to generator-enforced 
 * embed URLs, neutralizing unpredictable iframe layout shifts.
 * @module project/ProjectCard/utils
