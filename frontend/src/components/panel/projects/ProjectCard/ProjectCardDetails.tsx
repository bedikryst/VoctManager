 ...
 * @architecture
 * Strictly presentational component ("Dumb Component"). Relies entirely on passed props
 * and utilizes CSS flexbox models (flex-1) to ensure vertical rhythm and alignment 
 * with adjacent sibling components in the CSS Grid layout.
    ...
    <>
      <div className="bg-white border border-stone-200/80 rounded-2xl p-5 shadow-sm flex-1 flex flex-col">
        <h4 className="flex items-center gap-2.5 text-[10px] font-bold antialiased uppercase tracking-widest text-stone-500 mb-3">
          <AlignLeft size={16} className="text-[#002395]"/> Opis wydarzenia
        </h4>
        {project.description ? (
      ...
      <div className="bg-white border border-stone-200/80 rounded-2xl p-4 shadow-sm">
        <h4 className="flex items-center gap-2.5 text-[10px] font-bold antialiased uppercase tracking-widest text-stone-500 mb-3">
          <Shirt size={16} className="text-[#002395]"/> Dress Code
        </h4>
