...
export default function ProgramWidget({ project, onEdit, onOpenMicroCast }: ProgramWidgetProps): React.JSX.Element {
    // Inherit referentially stable lists natively via scoped cache retrieval
    const { pieces, pieceCastings, participations: projectParticipations } = useProjectData(String(project.id));
