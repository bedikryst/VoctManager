...
export default function RehearsalsTab({ projectId }: RehearsalsTabProps): React.JSX.Element | null {
    const {
        isLoading, isSubmitting, rehearsalToDelete, setRehearsalToDelete,
        isDeleting, formData, setFormData, targetType, setTargetType,
        selectedSections, customParticipants, projectRehearsals,
        projectParticipations, artistMap, handleAdd, handleDeleteClick,
        executeDelete, toggleSection, toggleCustomParticipant
            ...
            <div className="space-y-4">
                ...
                {isLoading ? (
                    <div className="flex justify-center p-8">
                        <Loader2 size={24} className="animate-spin text-stone-400" aria-hidden="true" />
                    </div>
