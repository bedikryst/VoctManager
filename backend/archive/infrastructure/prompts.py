...
ANALYZE_SCORE = Prompt(
    ...
    system=(
        ...
        "  - epoch: ONE code for the stylistic period of THIS edition — MED, "
        "    REN, BAR, CLA, ROM, M20, CON, POP, FOLK, OTH. For an arrangement "
        "    use the arrangement's period (a living arranger ⇒ CON). Null if "
        "    unsure.\n"
