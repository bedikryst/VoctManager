  ...
  integrations: [
    ...
    sitemap({
      filter: (page) =>
        ...
        // /fundacja is deployed but not announced: `noindex` while FOUNDATION_PAGE_LINKED is
        // false in src/data/foundationSupport.ts. Drop this clause together with that flag.
        !/\/fundacja$/.test(new URL(page).pathname),
